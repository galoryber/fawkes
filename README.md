...
compress | `compress -action <create\|list\|extract> -path <path> [-format zip\|tar.gz] [-output <out>] [-pattern *.txt]` | Create, list, or extract zip/tar.gz archives for data staging. Auto-detects format from extension. Pattern filter, depth/size limits. Cross-platform (T1560.001).
