...
last | `last [-action logins\|failed] [-count 25] [-user <username>]` | Show login history and failed login attempts. Linux: parses wtmp/btmp. Windows: Security event log (4624/4625). macOS: native `last`. (T1087.001, T1110).
