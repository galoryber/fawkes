...
persist | `persist -method <method> -action <install\|remove>` | **(Windows, Linux, macOS)** Install or remove persistence. Windows: registry, startup-folder, com-hijack, screensaver, ifeo. Linux: crontab, systemd, shell-profile, ssh-key. macOS: launchagent. All methods support install/remove/list (T1547.001, T1053.003, T1543.002, T1546.004, T1098.004).
