...
sniff | `sniff [-interface eth0] [-duration 30] [-ports 21,80,445] [-promiscuous true]` | Passive network sniffing via AF_PACKET raw socket. Auto-extracts HTTP Basic Auth, FTP credentials, NTLM domain\user. BPF kernel-level port filtering. Linux only (T1040).
