...
hollow | `hollow -filename <shellcode> [-target <process>] [-ppid <pid>] [-block_dlls true]` | Process hollowing — create suspended process, write shellcode, redirect execution. **Windows:** CREATE_SUSPENDED + SetThreadContext, PPID spoofing, DLL blocking. **Linux:** PTRACE_TRACEME + /proc/mem write. MITRE T1055.012.
