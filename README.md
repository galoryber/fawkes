...
cloud-metadata | `cloud-metadata -action <detect\|all\|creds\|identity\|userdata\|network\|aws-iam\|azure-graph\|gcp-iam> [-provider <auto\|aws\|azure\|gcp\|digitalocean>] [-timeout 3]` | Probe cloud instance metadata services for IAM credentials, identity, user-data, and network config. aws-iam/azure-graph/gcp-iam enumerate cloud privileges via API. Auto-detects provider. AWS IMDSv2 support. Cross-platform (T1552.005, T1580).
