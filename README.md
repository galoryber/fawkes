...
socks | `socks <start\|stop\|stats> [port]` | Start, stop, or view stats for SOCKS5 proxy. Default port 7000. Stats shows active connections, bytes TX/RX, recent history. Tunnel tools like proxychains, nmap, or Impacket through the agent.
