...
service | `service -action <query\|start\|stop\|create\|delete\|list\|enable\|disable> -name <name> [-binpath <path>]` | **(Windows only)** Manage Windows services via SCM API — enable/disable changes start type (T1543.003, T1562.001).
