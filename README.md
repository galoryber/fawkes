...
execute-shellcode | `execute-shellcode` | Execute shellcode in the current process. Windows: VirtualAlloc + CreateThread. Linux: mmap + mprotect. macOS: MAP_JIT (ARM64) or mmap + mprotect (x86_64). No cross-process injection — runs in a new thread within the agent. Cross-platform (T1059.006).
