function(task, responses){
    ...
    try {
        ...
        let rows = [
            {"Property": {"plaintext": "Technique"}, "Value": {"plaintext": "OPUS Injection", "cellStyle": {"fontWeight": "bold"}}, "rowStyle": {}},
        ...
        return {"table": [{"headers": headers, "rows": rows, "title": "OPUS technique injection"}]};
    } catch(error) {
        let combined = "";
        for(let i = 0; i < responses.length; i++){
            combined += responses[i];
