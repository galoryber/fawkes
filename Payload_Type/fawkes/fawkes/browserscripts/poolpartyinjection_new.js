function(task, responses){
    ...
    try {
        ...
        let rows = [
            {"Property": {"plaintext": "Technique"}, "Value": {"plaintext": "PoolParty Injection", "cellStyle": {"fontWeight": "bold"}}, "rowStyle": {}},
        ...
        return {"table": [{"headers": headers, "rows": rows, "title": "PoolParty variant injection"}]};
    } catch(error) {
        let combined = "";
        for(let i = 0; i < responses.length; i++){
            combined += responses[i];
