function(task, responses){
    ...
    try {
        ...
        let rows = [
            {"Property": {"plaintext": "Technique"}, "Value": {"plaintext": "Vanilla Injection", "cellStyle": {"fontWeight": "bold"}}, "rowStyle": {}},
        ...
        return {"table": [{"headers": headers, "rows": rows, "title": "CreateRemoteThread injection"}]};
    } catch(error) {
        let combined = "";
        for(let i = 0; i < responses.length; i++){
            combined += responses[i];
