function(task, responses){
    ...
    try {
        ...
        let rows = [
            {"Property": {"plaintext": "Technique"}, "Value": {"plaintext": "Process Hollowing", "cellStyle": {"fontWeight": "bold"}}, "rowStyle": {}},
        ...
        return {"table": [{"headers": headers, "rows": rows, "title": "Process hollowing injection"}]};
    } catch(error) {
        let combined = "";
        for(let i = 0; i < responses.length; i++){
            combined += responses[i];
