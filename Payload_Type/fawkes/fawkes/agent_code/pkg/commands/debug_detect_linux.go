...
func checkProcMaps() debugCheck {
	...
	if len(found) > 0 {
		...
		return debugCheck{
			...
			Status:  "DETECTED",
			Details: fmt.Sprintf("Suspicious libraries: %s", strings.Join(unique, ", ")),
		}
	}
