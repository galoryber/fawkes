...
func (c *VSSCommand) Description() string {
	return "Impact techniques — shutdown, reboot (T1529). Linux does not support VSS operations."
}
...
func vssShutdown(args vssArgs) structs.CommandResult {
	...
	// If we get here, shutdown was initiated — system will power off shortly
