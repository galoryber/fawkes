...
func TestChromeTimeToString(t *testing.T) {
	tests := []struct {
		...
		{"zero", 0, "never"},
		{"negative", -1, "never"},
		{"pre-unix-epoch", 100000, "unknown"},
		// 2024-01-15 12:00:00 UTC = 13351536000000000 Chrome time
		{"valid-date", 13351536000000000, "2024-01-15 12:00:00"},
		// 2020-01-01 00:00:00 UTC
		{"year-2020", 13228272000000000, "2020-01-01 00:00:00"},
	}
