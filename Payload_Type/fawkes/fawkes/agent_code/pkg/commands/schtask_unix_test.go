...
func TestSchtaskUnix_Name(t *testing.T) {
	cmd := &SchtaskCommand{}
	if cmd.Name() != "schtask" {
...
func TestSchtaskUnix_EmptyParams(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_InvalidJSON(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_UnknownAction(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_QueryNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_DeleteNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_RunNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_EnableNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_DisableNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_StopNoName(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_CreateNoProgram(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_CreateAtNoTime(t *testing.T) {
	cmd := &SchtaskCommand{}
...
func TestSchtaskUnix_ListAction(t *testing.T) {
	cmd := &SchtaskCommand{}
